package xyz.savesx2.ui.screens
...
import xyz.savesx2.ui.SortBy
import xyz.savesx2.ui.components.SaveCard
import xyz.savesx2.ui.components.StorageBar
            ...
            if (selectedSaveNames.isNotEmpty()) {
                FloatingActionButton(
                    ...
                    Row(
                        ...
                        Text(
                            text = if (selectedSaveNames.size == 1) "Export Save" else "Export (${selectedSaveNames.size})",
